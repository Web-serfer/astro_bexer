...
const englishLang = languages.filter((item) => item.languageCode === "ru");
const filterLangs = languages.filter((item) => item.languageCode !== "ru");
...
fs.readdir(configDir, (err, files) => {
  ...
  files.forEach((file) => {
    if (file.startsWith("menu.") && file !== "menu.ru.json") {
